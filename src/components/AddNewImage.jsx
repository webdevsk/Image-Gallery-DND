  ...
  return (
    <>
      ...
      <label
        ...
        className={`relative flex cursor-pointer flex-col place-items-center items-center justify-center gap-1 border-2 bg-gray-100 text-center text-gray-800 transition-colors hover:bg-gray-50 peer-disabled:opacity-50 ${className}`}
      >
